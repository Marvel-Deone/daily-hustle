...
//                 const scale = Math.max(0.92, 1 - distance / 1000)
//                 const opacity = Math.max(0.5, 1 - distance / 800)
...
//                     <div
//                         className="flex gap-6 w-max animate-carousel hover:[animation-play-state:paused]"
//                     >
//                         {reviews.map((review, index) => (
//                         <div
//                             key={index}
//                             className="snap-center shrink-0 w-[320px] md:w-[386px]
//   !rounded-[2rem] shadow-md relative hover:shadow-xl hover:shadow-[#c4162a]/20
//   hover:-translate-y-2.5 transition-all duration-500 hover:border-[#c4162a]/20
//   p-8 h-full flex flex-col justify-between border hover:border-2 border-gray-100"
//                         >
//                             <div>
...
//     bg-[linear-gradient(to_right,#f9fafb,transparent_15%,transparent_85%,#f9fafb)]" />
...
//                             <div
//                                 key={index}
//                                 className="review-card shrink-0 w-[320px] md:w-[386px]
//           rounded-[2rem] shadow-md p-8 flex flex-col justify-between
//           border border-gray-100 bg-white transition-all duration-500"
//                             >
//                                 <div>
//                                     <div className="flex items-center space-x-1 text-yellow-400 mb-6 text-xs">
//                                         ★★★★★
